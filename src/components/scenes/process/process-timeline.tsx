...
export function ProcessTimeline() {
  ...
  return (
    <section
      ref={sectionRef}
      id="process"
      className="noise overflow-hidden bg-ink-900 py-24 sm:py-28 lg:flex lg:h-svh lg:flex-col lg:justify-center lg:py-0"
    >
      <div className="container-site">
        ...
        <div
          ref={trackRef}
          className="mt-10 flex flex-col gap-4 lg:w-max lg:flex-row lg:gap-6"
        >
          {processSteps.map((step) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="flex size-10 items-center justify-center rounded-md bg-brand-500/15 text-brand-300">
        ...
        <p className="mt-10 hidden font-mono text-xs uppercase tracking-[0.2em] text-neutral-400 lg:block">
