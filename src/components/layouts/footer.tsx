  ...
  return (
    <footer className="noise bg-ink-950 text-neutral-400">
      <div className="container-site">
        <div className="glass-dark relative -translate-y-16 rounded-lg p-8 sm:p-10 lg:flex lg:items-center lg:justify-between lg:gap-12">
          <div className="max-w-md">
            <h2 className="text-h3 font-semibold text-white">
              Operations intelligence, monthly.
            </h2>
            <p className="mt-2 text-sm leading-relaxed">
              Benchmarks, site walkthroughs and facility ops playbooks from 25
              years on the ground. No sales sequences.
            </p>
          </div>
        ...
        <div className="grid gap-12 pb-16 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
              ...
              {socialLinks.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    className="flex size-10 items-center justify-center rounded-full border border-white/10 text-neutral-400 transition-colors hover:border-brand-400 hover:text-white"
                  >
                    <svg
                      viewBox="0 0 24 24"
          ...
          <nav aria-label="Footer services">
            <p className="font-mono text-eyebrow uppercase text-neutral-400">
              Services
            </p>
